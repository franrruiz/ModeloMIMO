r_ = cell(2,2,1,9,40);
Mfin_ = zeros(2,2,1,9,40);
MSE_ = zeros(2,2,1,9,40);
BER_ = zeros(2,2,1,9,40);
pOnOff_ = zeros(2,2,1,9,40);
acierto = zeros(2,2,1,9,40);
aciertoM = zeros(2,2,1,9,40);
fChi=0;
T=500;
...
for f=0
    for l=10
        for snr=-3:1:5
            ...
            BASEDIR=['/export/clusterdata/ivalera/modMIMOpruebasCluster/flag' num2str(f) '_L' num2str(l) '_SNR' num2str(snr) '_T'  num2str(T)];
