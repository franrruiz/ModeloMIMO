...
%T1_DEP.eps
figure,plot(SNRvec,1-reshape(sum(acierto(f+1,fChi+1,L1,:,:),5),1,length(SNRvec))/40,SNRvec,1-reshape(sum(aciertoM(f+1,fChi+1,L1,:,:),5),1,length(SNRvec))/40,'linewidth',2)
grid on
