...
BASEDIR=['/export/clusterdata/ivalera/modMIMOpruebasCluster/flag' num2str(flag) '_L' num2str(L) '_SNR' num2str(SNR) '_T'  num2str(T)];
...
try
    ...
    [Zest,Hest,MestIt,pX_ZIt,rest,nest] = MIMO_aprender_H_s2x(X,chi,tau,nu,alpha1, alpha2,gamma1,gamma2,beta,pii,lambda,Nsim, flag);
