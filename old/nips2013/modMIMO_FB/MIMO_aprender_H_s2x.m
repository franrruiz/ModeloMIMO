function  [Zest,Hest,MestIt,pX_ZIt,chiIt,rest,nest] = MIMO_aprender_H_s2x(X,chi,tau,nu,alpha,gamma1,gamma2,beta,Nsim)
...
for it=1:Nsim
    ...
    %% pasos a) y b): Gibbs
    [Zest, rest,Hest,MestIt(it),nest]= MIMO_FB(X,Zest,nest,rest,chi,tau,nu,alpha,gamma1,gamma2,beta,1);
    %% Muestreo r
    for itMH=1:10
        for m=1:MestIt(it)
            rnew=rest;
