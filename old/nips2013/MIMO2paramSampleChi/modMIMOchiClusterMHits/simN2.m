function simN2(L,SNR,T,itcluster,flag)
BASEDIR=['/export/clusterdata/ivalera/modMIMOsampleChiNewMHitsN2T400/flag' num2str(flag) '_L' num2str(L) '_SNR' num2str(SNR) '_T'  num2str(T)];
