...
%constitutes one of the first steps in the research on the application of Bayesian nonparametric approaches to signal processing for communications.

%shed light on future research for the application of Bayesian nonparametric approaches to signal processing for communications.
