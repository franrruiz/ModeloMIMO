#!/bin/sh
#T2000_Nt6_Npart3000_test.sh
#Torque script to run Matlab program

#Torque directives
#PBS -N T2000_Nt6_Npart3000_test
#PBS -W group_list=yetidsi
#PBS -l nodes=1:ppn=16,walltime=10:00:00,mem=16gb
...
onOffModel=0
Nparticles=3000
blockNtSize=10000000
flagParallel=1
itCluster=1
simId=3

#Command to execute Matlab code
matlab -nosplash -nodisplay -nodesktop -r "simClusterWise_yeti($T,$Nt,$Nr,$M,$L,$Niter,$lHead,$onOffModel,$Nparticles,$blockNtSize,$flagParallel,$itCluster,$simId)" > sal_T2000_Nt6_Npart3000_test.txt
