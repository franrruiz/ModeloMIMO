#!/bin/sh
#T2000_Nt6_Npart3000.sh
#Torque script to run Matlab program

#Torque directives
#PBS -N T2000_Nt6_Npart3000
...
matlab -nosplash -nodisplay -nodesktop -r "simClusterWise_yeti($T,$Nt,$Nr,$M,$L,$Niter,$lHead,$onOffModel,$Nparticles,$blockNtSize,$flagParallel,$itCluster,$simId)" > sal_T2000_Nt6_Npart3000.txt
