function simClusterSynGreedy(T,Nt,Nr,M,Ltrue,L,SNR,Niter,lHead,onOffModel,Nparticles,flagParallel,itCluster,simId)
% NOTE: Designed to be called with simId=23 and read data as if it were simId=21
