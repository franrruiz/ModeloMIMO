...
% Sweep and hold variables:
  sweep_var = 'SNR'; sweep_vec = -5:3:13; simId = 2; etiquetaX='SNR (dB)'; lugar='NorthEast'; hold_var='Nr'; hold_vec=20;
  %sweep_var = 'Nt'; sweep_vec = 2:2:10; simId = 2; etiquetaX='#Transmitters'; lugar='NorthWest'; hold_var='SNR'; hold_vec=10;
  %sweep_var = 'Nr'; sweep_vec = 5:5:20; simId = 3; etiquetaX='#Receivers'; lugar='NorthEast'; hold_var='SNR'; hold_vec=-3;
  %sweep_var = 'M'; sweep_vec = 2:1:7; simId = 2; etiquetaX='log_2|A|'; lugar='NorthWest'; hold_var='SNR'; hold_vec=10;
...
for holdV=hold_vec
    ...
    boxMEST = zeros(maxItCluster,length(sweep_vec));
    ...
    if(plotToFile)
        ...
        print('-dpdf',['./plots/ADER_' sweep_var '_s.pdf']);
        figurapdf(anchoLar,altoLar);
        print('-dpdf',['./plots/ADER_' sweep_var '_g.pdf']);
    end
    ...
    if(plotToFile)
        figurapdf(anchoSm,altoSm);
        print('-dpdf',['./plots/SER_' sweep_var '_s.pdf']);
        figurapdf(anchoLar,altoLar);
        print('-dpdf',['./plots/SER_' sweep_var '_g.pdf']);
    end
    ...
    if(plotToFile)
        figurapdf(anchoSm,altoSm);
        print('-dpdf',['./plots/MSE_' sweep_var '_s.pdf']);
        figurapdf(anchoLar,altoLar);
        print('-dpdf',['./plots/MSE_' sweep_var '_g.pdf']);
    end
    ...
    if(plotToFile)
        figurapdf(anchoSm,altoSm);
        print('-dpdf',['./plots/DEP_' sweep_var '_s.pdf']);
        figurapdf(anchoLar,altoLar);
        print('-dpdf',['./plots/DEP_' sweep_var '_g.pdf']);
    end
    ...
    if(plotToFile)
        figurapdf(anchoSm,altoSm);
        print('-dpdf',['./plots/BoxM_' sweep_var '_s.pdf']);
        figurapdf(anchoLar,altoLar);
        print('-dpdf',['./plots/BoxM_' sweep_var '_g.pdf']);
    end
end
